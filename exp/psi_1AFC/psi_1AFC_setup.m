...
%   psi.TTL_t       - TTL pulse length (1 ms)
%   psi.TTL_V       - TTL pulse amplitude (5 V)
%
%
%   % Trial design
...
%
%   % Buttons
%   psi.lpt_adr1    - parallel port address (see device manager - LPT1 details - resources)
%   psi.lpt_adr2    - as above but 'I/O Range' #2
...
psi.trials_test = [5; 10;];
psi.stim_test = [0; psi.near_p;]; % performance levels > guess & < lapse rate
...
%% Trial design
psi.fix_t = 0.500; %1.000;
psi.cue_t = 1.000;
psi.stim_delay = [0.1 0.9]; % [0.885 0.885];
...
%% Buttons
psi.lpt_adr1 = '3FF8';% '378';
psi.lpt_adr2 = '3FF4';% hex2dec(psi.lpt_adr1) + 1024
psi.lpt_dir = 'bi';
psi.btn = [2 3];
psi.btn_esc = 1;
